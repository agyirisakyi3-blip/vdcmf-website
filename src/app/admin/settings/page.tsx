  ...
  return (
    <AdminLayout title="Site Settings" subtitle="Manage global site settings">
      ...
      <style jsx>{`
        ...
        .group-title { font-size: 1rem; color: #1C1C1C; margin-bottom: 12px; text-transform: uppercase; letter-spacing: 0.5px; font-family: "DM Sans", sans-serif; }
        .settings-card { overflow: hidden; }
        .field-row { display: flex; align-items: center; gap: 16px; padding: 14px 20px; border-bottom: 1px solid #EDEDED; }
        .field-row:last-child { border-bottom: none; }
        .field-label { min-width: 200px; font-size: 0.85rem; font-weight: 600; color: #1C1C1C; text-transform: capitalize; display: flex; flex-direction: column; gap: 2px; }
